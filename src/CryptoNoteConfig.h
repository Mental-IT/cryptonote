...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x4105;
...
const int      P2P_DEFAULT_PORT                              = 17767;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 18767;
...
const std::initializer_list<const char*> SEED_NODES = {
  //"crypto.rouget.be:17767",
  //"crypto2.rouget.be:18767",
};
